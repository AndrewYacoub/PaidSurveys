...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { response: @opinion.response, survey_id: @opinion.survey_id, user_id: @opinion.user_id } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { response: @opinion.response, survey_id: @opinion.survey_id, user_id: @opinion.user_id } }
