...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { content: @choice.content, question_id: @choice.question_id } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { content: @choice.content, question_id: @choice.question_id } }
